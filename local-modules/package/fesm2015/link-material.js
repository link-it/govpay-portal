 ...
 * @suppress {checkTypes,extraRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ShoppingInfo extends Standard {
    /**
     * @return {?}
     */
    get icon() {
 ...
 * @suppress {checkTypes,extraRequire,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class AvvisoPagamentoComponent {
    constructor() {
    ...
    ngOnChanges(changes) {
        ...
        if (changes['_payments'] && changes['_payments'].currentValue && changes['_payments'].currentValue.length > 1) {
            this._totale = changes._payments.currentValue.reduce((a, b) => {
                return a + b.importo;
            }, 0);
        }
