...
@Component({
  selector: 'pay-item-ext',
  templateUrl: './pay-item-ext.component.html',
  styleUrls: ['./pay-item-ext.component.scss']
})
export class PayItemExtComponent implements AfterViewInit, AfterContentChecked {
  ...
  @Input('metadata1') _metaData1: string = '';
  @Input('metadata2') _metaData2: string = '';
  ...
  @Output('on-item-click') _itemClick: EventEmitter<any> = new EventEmitter(null);
